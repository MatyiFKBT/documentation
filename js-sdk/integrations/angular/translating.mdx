...
:::info
To enable parameter interpolation, you need to use some [message formatter](/js-sdk/formatting).
:::
...
[`FormatSimple`](/api/core_package/format_simple.mdx) or [`FormatIcu`](/platform/icu_message_format)
